...
import com.leq.singlepart.autofindwaybin.BackGroundPanel;
...
public class BasePanel extends JFrame {
	...
	public static MyPanel reset = new MyPanel(0, 0);// 起点
	...
	public static MyPanel fish = new MyPanel(ThreadLocalRandom.current().nextInt(widthLength),
			ThreadLocalRandom.current().nextInt(heightLength));// 随机生成终点
